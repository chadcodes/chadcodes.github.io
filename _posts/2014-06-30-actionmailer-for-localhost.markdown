...
If you’re still following, take a quick break to `git`, grab a coffee and stretch.  Next steps are the configure the mailer smtp settings, add in your mail password to the secrets.yml file then test.
